...
const uint16_t PROGMEM p_bspc_pipe[] = {KC_O, KC_P, COMBO_END};
const uint16_t PROGMEM l_scln_dash[] = {KC_L, KC_SCLN, COMBO_END};
const uint16_t PROGMEM scln_quot_dquot[] = {KC_SCLN, KC_QUOT, COMBO_END};
combo_t key_combos[COMBO_COUNT] = {
    COMBO(p_bspc_pipe, KC_PIPE),
    COMBO(l_scln_dash, KC_MINS),
    COMBO(scln_quot_dquot, KC_DQUO),
};
...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LCTL, KC_LALT, MO(_NUM),TD(LWRTD),KC_SPC,TD(RSETD),KC_LEFT, KC_DOWN, PATHBACK, LGUI(KC_D)
),

[_TILWM] = LAYOUT_planck_mit(
...
[_LOWER] = LAYOUT_planck_mit(
    ...
    _______, _______,  _______,   _______,   _______,  _______,  _______,  _______, _______, _______, _______,  _______,
    MO(_ADJUST), _______, _______, _______, _______, KC_UNDS, TILWM, _______,    KC_VOLD, KC_VOLU, QK_BOOT
),
...
[_RAISE] = LAYOUT_planck_mit(
    ...
    KC_DEL,  KC_EQL,  KC_MINS, XXXXXXX, KC_PLUS, KC_F5,   KC_F6,   XXXXXXX, XXXXXXX,  KC_LBRC, KC_RBRC, KC_BSLS,
