...
const uint16_t PROGMEM o_p_bspc[] = {KC_Y, KC_SCLN, COMBO_END};
const uint16_t PROGMEM a_s_esc[] = {KC_A, KC_R, COMBO_END};
...
/*
  [_QWERTY] = LAYOUT_ortho_4x10(
    ...
    KC_LCTL, KC_LGUI, KC_NO, TD(LWRTD), KC_SPACE, KC_SPACE, TD(RSETD), KC_NO,   KC_LALT, KC_RCTL),
*/
  [_COLEMAK] = LAYOUT_ortho_4x10(
    KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,
    KC_A,    KC_R,    KC_S,    MT(MOD_LSFT, KC_T),    KC_D,    KC_H,    MT(MOD_LSFT, KC_N),    KC_E,    KC_I,    KC_O,
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_ENTER,
  ...
  [_LOWER] = LAYOUT_ortho_4x10(
    ...
    KC_NO,     KC_NO,    KC_NO,    KC_NO,       KC_NO,       KC_NO,   KC_NO,   KC_NO, KC_NO,    TG(_COLEMAK)),
  [_RAISE] = LAYOUT_ortho_4x10(
    ...
    KC_EQUAL, KC_PLUS, LSFT(KC_EQUAL), _______, LSFT(KC_NO), KC_LEFT, KC_PIPE, KC_MINS, KC_LBRC, KC_RBRC,
